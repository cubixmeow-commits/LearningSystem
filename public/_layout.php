...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/twilight.css">
</head>
<body>
  <div class="wrap">
    <header class="site-header">
      ...
      <nav class="nav" aria-label="Primary">
        <a href="/"<?= $current === 'items' ? ' aria-current="page"' : '' ?>>Items</a>
        <a href="/topics.php"<?= $current === 'topics' ? ' aria-current="page"' : '' ?>>Topics</a>
        <a href="/lessons.php"<?= $current === 'lessons' ? ' aria-current="page"' : '' ?>>Lessons</a>
        <a href="/claims.php"<?= $current === 'claims' ? ' aria-current="page"' : '' ?>>Claims</a>
        <a href="/add.php"<?= $current === 'add' ? ' aria-current="page"' : '' ?>>Add repo</a>
      </nav>
    </header>
<?php
}
